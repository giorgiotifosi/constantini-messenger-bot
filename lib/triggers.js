 ...
 * Off by default — set KITCHEN_TEXT_TRIGGER on Vercel only if you want reply-based send.
 */
...
/**
 * Page greeting echo = chat opened from Chat builder (no customer tap).
 * Default ON so photos send when the thread opens, not when user taps a button.
 */
