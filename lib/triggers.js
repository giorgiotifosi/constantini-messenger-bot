...
/** Default off — photos send on button tap only, not when ad opens the chat. */
export function shouldSendPhotosOnChatOpen() {
  return process.env.MESSENGER_AD_CHAT_OPEN === "true";
}
